...
export default function OrgVerificationSection({ orgId }: { orgId: string }) {
  ...
  return (
    <section id="verification" className="bg-white rounded-2xl border-2 border-gray-100 p-4 lg:p-6 mb-4">
      ...
      {isVerified ? (
        ...
        <>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 rounded-xl border-2 border-gray-200 focus:border-primary outline-none text-sm mb-3"
          />
