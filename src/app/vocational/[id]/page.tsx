          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-5 mt-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2 text-sm">
                <span className="bg-white/15 backdrop-blur px-3 py-1 rounded-full font-semibold">{levelLabelKeys[track.level as string] ? t(levelLabelKeys[track.level as string]) : track.level}</span>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white rounded-2xl p-6 shadow-sm border-r-4 border-emerald-500">
            <div className="text-sm text-gray-500 mb-1">{t('dp.voc.salary_lb')}</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border-r-4 border-blue-500">
            <div className="text-sm text-gray-500 mb-1">{t('dp.voc.salary_gulf')}</div>
