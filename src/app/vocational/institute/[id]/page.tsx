...
export default function InstituteDetailPage() {
  ...
  if (!inst) {
    return <main className="min-h-screen bg-bg-soft flex items-center justify-center" dir="rtl"><div className="text-center"><div className="text-6xl">🔍</div><h1 className="text-2xl font-bold text-[#1b3a6b] mt-4">المعهد غير موجود</h1><Link href="/vocational" className="mt-4 inline-block px-5 py-2.5 bg-[#1b3a6b] text-white rounded-lg font-bold">← العودة</Link></div></main>;
  }
      ...
      <section className="bg-gradient-to-br from-[#1b3a6b] to-[#2d5391] text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-5 mt-4">
            ...
            {inst.website && <a href={inst.website} target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 bg-surface text-[#1b3a6b] rounded-lg font-bold text-sm">🌐 الموقع</a>}
          </div>
        </div>
      </section>
