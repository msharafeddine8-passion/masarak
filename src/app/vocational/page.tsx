...
const INSTITUTES: Institute[] = [
  { id:1, name:"المعهد التقني العالي — منطقة الشيّاح",  region:"بيروت",     type:"رسمي",  specialties:["كهرباء","إلكتروني�ات", years:"بعد الصف 9", color:"bg-white/15" },
                    ...
                    <div className="p-5">
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 flex-wrap mb-1">
                            <span className={`text-xs font-extrabold px-2 py-0.5 rounded-full ${LEVEL_COLORS[t.level]}`}>{t.code}</span>
                      ...
                      {t.uniEquiv && (
                        <div className="bg-blue-50 rounded-xl p-3 text-xs mb-3">
                          ...
                          <span className="ات", years:"بعد الصف 9", color:"bg-white/15" },
              { code:"BT", label:"Bac Technique",     duration:"2 سنوات", years:"بعد الصف 9 أو LT", color:"bg-white/20" },
              { code:"TS", label:"Technicien Supérieur",duration:"2 سنوات", years:"بعد BT أو BAC", color:"bg-white/25" },
            ].map(s => (
              <div key={s.code} className={`${s.color} rounded-2xl p-4 text-center`}>
        ...
        {activeTab === "guide" && (
          <div className="space-y-6">
              ...
              <div className="overflow-x-auto">
                <div className="flex items-start gap-4 min-w-[600px] pb-4">
                  {[
                    ...
                    { step:"جامعة", label:"معادلة أو قبول مشريط", color:"bg-green-100 text-green-700", arrow:false },
                  ].map((s, i) => (
            ...
            {/* FAQ */}
            {[
              { q:"م�� الفرق بين LT وBT وTS؟", a:"LT (Licence Technique) هو شهادة تقنية أساسية مدتها 3 سنوات بعد الصف التاسع. BT (Baccalauréat Technique) شهادة أعلى تفتح باب الجامعة. TS (Technicien Supérieur) هو الأعلى في السلم التقني ومعادل لسنتين جامعيتين في بعض التخصصات." },
              { q:"هل تقبل الجامعات اللبنانية شهادات BT وTS؟", a:"نعم، الجامعة اللبنانية تقبل BT في تخصصات مقابلة. LAU وNDU وAUB قد تقبل TS مع امتحانات إصافية. بعض الجامعات لديها برامج موجهة لحاملي TS مع تسريع في التخرج." },
              ...
              { q:"كيف أحصل عمل معادلة شهادتي في لبنان؟", a:"يمكن تقديم طلب معادلة لدى وزارة التربية والتعليم العالي. المعادلة تحدد ما إذا كانت شهادتك تعادل جزءاً من الدراسة الجامعية. المعادلات تختلف حسب الجامعة والتخصص." },
        ...
        <div className="mt-10 bg-gradient-to-r from-orange-500 to-amber-600 rounded-3xl p-8 text-white text-center">
          ...
          <p className="text-orange-100 mb-6">اكتشف مسارك الن��الي — أكاديمي أم تقني — من خلال اختبار Career DNA</p>
