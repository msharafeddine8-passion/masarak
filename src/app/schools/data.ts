...
export const SCHOOLS: School[] = [
  ...
  { id:3,  name:"ثانوية الجمهور الرسمية",                region:"جبل لبنان", area:"الجمهور",      type:"رسمية",   curriculum:["لبناني"],               lang:"عربي/فرنسي",   feesMin:0,    feesMax:0,     grades:"7-12",  founded:1960, students:2000, rating:3, features:["تعليم مجاني","منهج رسمي"],                 desc:"من المدارس الرسمية الكبرى في منطقة الجمهور بجبل لبنان.",          emoji:"🏫", color:"from-red-600 to-red-800" },
