...
const SCHOOLS: School[] = [
  ...
  { id:3,  name:"ثانوية الجمهور الرسمية",                region:"بيروت", area:"الجمهور",      type:"رسمية",   curriculum:["لبناني"],               lang:"عربي/فرنسي",   feesMin:0,    feesMax:0,     grades:"7-12",  founded:1960, students:2000, rating:3, features:["تعليم حكومي","منهج رسمي"],                 desc:"من المدارس الرسمية الكبرى في بيروت.",          emoji:"🏫", color:"from-red-600 to-red-800" },
  ...
  { id:15, name:"الثانوية الرسمية — عاليه",               region:"جبل لبنان",area:"عاليه",     type:"رسمية",   curriculum:["لبناني"],               lang:"عربي/فرنسي",   feesMin:0,    feesMax:0,     grades:"7-12",  founded:1958, students:1200, rating:3, features:["تعليم حكومي","منهج لبناني"],               desc:"من الثانويات الرسمية في جبل لبنان.",           emoji:"🏫", color:"from-red-500 to-red-700" },
  // ─── الشمال ───────────────────────────────────────────────────────────────
  ...
  { id:18, name:"ثانوية عبد الحميد كرامي الرسمية",       region:"الشمال", area:"طرابلس",     type:"رسمية",   curriculum:["لبناني"],               lang:"عربي/فرنسي",   feesMin:0,    feesMax:0,     grades:"7-12",  founded:1953, students:2500, rating:3, features:["تعليم حكومي"],                             desc:"من أبرز الثانويات الرسمية في طرابلس.",         emoji:"🏫", color:"from-red-500 to-red-700" },
  ...
  { id:22, name:"ثانوية النبطية الرسمية",                 region:"الجنوب", area:"النبطية",    type:"رسمية",   curriculum:["لبناني"],               lang:"عربي/فرنسي",   feesMin:0,    feesMax:0,     grades:"7-12",  founded:1962, students:1800, rating:3, features:["تعليم حكومي"],                             desc:"من الثانويات الرسمية في النبطية.",             emoji:"🏫", color:"from-red-500 to-red-700" },
  // ─── البقاع ───────────────────────────────────────────────────────────────
  { id:23, name:"مدارس الأونروا — البقاع",               region:"البقاع", area:"زحلة",       type:"رسمية",   curriculum:["لبناني"],               lang:"عربي",         feesMin:0,    feesMax:0,     grades:"KG-9",  founded:1950, students:5000, rating:3, features:["تعليم للاجئين","دعم اجتماعي"],      desc:"مدارس الأمم المتحدة للاجئين في البقاع.",       emoji:"🏕️", color:"from-slate-500 to-slate-700" },
  ...
  { id:25, name:"ثانوية زحلة الرسمية",                   region:"البقاع", area:"زحلة",       type:"رسمية",   curriculum:["لبناني"],               lang:"عربي/فرنسي",   feesMin:0,    feesMax:0,     grades:"7-12",  founded:1960, students:2000, rating:3, features:["تعليم حكومي","منهج رسمي"],                 desc:"الثانوية الرسمية في مدينة زحلة.",             emoji:"🏫", color:"from-red-500 to-red-700" },
