      ...
      <div className="container mx-auto max-w-2xl">
        <div className="text-center mb-6">
          ...
          <div className="flex justify-center gap-2 mb-6" aria-hidden="true">
            {[0,1,2].map(i => (
              <div key={i} className={`h-1.5 w-12 rounded-full ${i <= step ? 'bg-primary' : 'bg-white/10'}`} />
            ))}
          </div>
        </div>

        <div className="bg-surface rounded-3xl border-2 border-white/10 p-6 md:p-8 shadow-sm">
          {step === 0 && (
            <>
