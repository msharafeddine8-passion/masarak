...
const ARTICLES: Record<string, ArticleData> = {
  ...
  "riasec-explained": {
    ...
    sections: [
      ...
      { tip: "💡 جرّب اختبار RIASEC على مسارك الآن!" },
    ],
  },
  ...
  "study-abroad-lebanon": {
    ...
    sections: [
      ...
      { h2: "أفضل وجهات للطلاب اللبنانيين", ul: ["كندا — سهولة الهجرة وجودة تعليم عالية", "ألمانيا — تعليم بلا رسوم للطلاب الأجانب في الجامعات الحكومية", "فرنسا — سهولة الوصول للناطقين بالفرنسية", "الإمارات وقطر — قرب جغرافي ورواتب مرتفعة"] },
