...
const CAREERS: Career[] = [
  ...
  { id: "pharmacist", title: "Pharmacist", titleAr: "صيدلي", emoji: "💊", category: "طب وصحة", demand: "عالي", demandColor: "bg-blue-100 text-blue-700", salaryLB: "$900–$2,500", salaryRemote: "N/A", yearsToEntry: "5 سنوات", description: "صرف الأدوية والإرشاد الدوائي. مهنة مستقرة جداً بلبنان مع إمكانية فتح صيدلية خاصة.", skills: ["كيمياء دوائية", "صيدلة سريرية", "تواصل مع المرضى", "إدارة مخزون"], certifications: ["ترخيص نقابة الصيادلة", "PharmD", "BCPS"], universities: ["USJ", "LAU", "LIU", "BAU"], roadmap: ["دراسة الكيمياء بالثانوية", "كلية صيدلة 5 سنوات", "إقامة دوائية", "ترخيص النقابة", "تخصص (سريرية/صناعة/مستشفى)"] },
  ...
  { id: "auditor", title: "External Auditor", titleAr: "مدقّق حسابات", emoji: "🔍", category: "محاسبة ومالية", demand: "عالي", demandColor: "bg-blue-100 text-blue-700", salaryLB: "$700–$2,500", salaryRemote: "Gulf $3,500+", yearsToEntry: "4–6 سنوات", description: "تدقيق القوائم المالية للشركات. Big 4 (EY/PwC/Deloitte/KPMG) أبواب مفتوحة لخريجي لبنان.", skills: ["IFRS", "Audit Procedures", "Excel", "Risk Assessment", "SAP"], certifications: ["ACCA", "CPA", "CIA"], universities: ["AUB", "LAU", "USJ", "ESA"], roadmap: ["محاسبة + GPA عالي", "تدريب Big 4 بالصيف", "Junior Auditor مباشر", "ACCA كاملة", "Manager خلال 5-7 سنوات"] },
