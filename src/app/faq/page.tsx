...
const FAQS_FOR_SCHEMA = [
  ...
  { question: "لمن مسارك؟", answer: "مسارك مخصّص للطلاب العرب من المرحلة المتوسطة (12 سنة) حتى ما بعد التخرج. أيضاً لأولياء الأمور والمدارس والجامعات." },
  ...
  { question: "هل بقدر أستعمل مسارك إذا أنا خارج بلدي؟", answer: "نعم! المنصة متاحة عالمياً وخصوصاً للمغتربين العرب. كل المحتوى بالعربية والإنجليزية." },
