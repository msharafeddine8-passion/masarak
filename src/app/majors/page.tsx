...
const MAJORS: Major[] = [
  // ── الطب والصحة ─────────────────────────────────────────────────────────────
  { id:1,  name:"طب بشري",          category:"الطب والصحة",           emoji:"🩺", years:6,  lang:"إنجليزي",       salaryMin:2500, salaryMax:5000,  salaryGulfMin:6500,  salaryGulfMax:11000, demandLB:"عالٍ جداً", demandGulf:"عالٍ جداً", difficulty:5, careers:["طبيب عام","طبيب متخصص","باحث طبي","طب طوارئ"],  desc:"أعرق التخصصات وأكثرها مكانةً. 6 سنوات دراسة + امتياز + تخصص. طلب لا ينتهي في لبنان والعالم.", riasec:"IS", universities:["AUB","LAU","USJ","UOB"],  roadmap:["العلوم الطبيعية (ص10-12)","BAC علوم","MCAT/Entrance Exam","طب عام (6 سنوات)","امتياز (سنة)","تخصص (3-7 سنوات)"], certifications:["USMLE","نقابة الأطباء","Board Certification"], skills:["تشريح","فيزيولوجيا","تشخيص سريري","بحث طبي","تواصل مع المرضى"] },
  { id:2,  name:"صيدلة",             category:"الطب والصحة",           emoji:"💊", years:5,  lang:"إنجليزي/فرنسي", salaryMin:1200, salaryMax:2800,  salaryGulfMin:3000,  salaryGulfMax:5500,  demandLB:"عالٍ",      demandGulf:"عالٍ جداً", difficulty:4, careers:["صيدلاني","باحث دوائي","مدير صيدلية","صيدلاني سريري"], desc:"علم الدواء وتأثيراته — طلب كبير في لبنان والخليج. فرص عمل في المستشفيات والشركات الدوائية الكبرى.", riasec:"IC", universities:["AUB","USJ","LAU","LIU"],  roadmap:["علوم (ص10-12)","BAC علوم","Pharmacy Entrance","5 سنوات صيدلة","تدريب سريري","PharmD اختياري"], certifications:["نقابة الصيادلة","PharmD"], skills:["كيمياء عضوية","بيوكيمياء","فارماكولوجيا","تفاعل الأدوية"] },
  { id:3,  name:"تمريض",             category:"الطب والصحة",           emoji:"🏥", years:4,  lang:"إنجليزي",       salaryMin:800,  salaryMax:1800,  salaryGulfMin:2000,  salaryGulfMax:3800,  demandLB:"عالٍ جداً", demandGulf:"عالٍ جداً", difficulty:3, careers:["ممرض","مشرف تمريض","ممرض ICU","مدير صحي"],       desc:"الطلب يتضاعف سنوياً — أعلى معدلات التوظيف. كندا وألمانيا والخليج يستقبلون ممرضين لبنانيين.", riasec:"SI", universities:["AUB","LAU","LIU","BAU"],  roadmap:["BAC علوم","Nursing Entrance","4 سنوات تمريض","تدريب مستشفى","NCLEX للهجرة"], certifications:["NCLEX-RN","BSN"], skills:["رعاية مرضى","إسعافات أولية","تواصل","تحمل ضغط"] },
  { id:4,  name:"طب أسنان",          category:"الطب والصحة",           emoji:"🦷", years:5,  lang:"إنجليزي/فرنسي", salaryMin:2000, salaryMax:4500,  salaryGulfMin:5000,  salaryGulfMax:8000,  demandLB:"عالٍ",      demandGulf:"عالٍ",      difficulty:4, careers:["طبيب أسنان","جراح فك","أستاذ جامعي"],             desc:"تخصص يتيح العمل الحر المستقل. عيادات خاصة تبدأ أرباحها بسرعة.", riasec:"IR", universities:["USJ","LAU","BAU","LIU"],  roadmap:["علوم (ص10-12)","BAC علوم","Dentistry Entrance","5 سنوات دراسة","امتياز"],  certifications:["نقابة أطباء الأسنان"], skills:["دقة يدوية","تشريح الفك","تواصل مع المرضى"] },
  // ── الهندسة والتكنولوجيا ────────────────────────────────────────────────────
  { id:5,  name:"هندسة الحاسوب",     category:"الهندسة والتكنولوجيا", emoji:"💻", years:4,  lang:"إنجليزي",       salaryMin:1500, salaryMax:3500,  salaryGulfMin:4000,  salaryGulfMax:7000,  demandLB:"عالٍ جداً", demandGulf:"عالٍ جداً", difficulty:4, careers:["مطور برمجيات","مهندس AI","مدير تقني","Cloud Engineer"], desc:"تخصص المستقبل — طلب هائل محلياً وعالمياً. الشركات التقنية تنافس على خريجي AUB وLAU.", riasec:"IR", universities:["AUB","LAU","AUT","LIU"],  roadmap:["رياضيات وفيزياء قوية","SAT/Entrance Exam","4 سنوات هندسة","تدريب صيفي","مشاريع GitHub","وظيفة أو ماستر"], certifications:["AWS Certified","Google Cloud","Microsoft Azure","Cisco CCNA"], skills:["Python","C++","Data Structures","System Design","SQL"] },
  { id:6,  name:"علوم الحاسوب",      category:"الهندسة والتكنولوجيا", emoji:"🖥️", years:4,  lang:"إنجليزي",       salaryMin:1500, salaryMax:3200,  salaryGulfMin:3500,  salaryGulfMax:6000,  demandLB:"عالٍ جداً", demandGulf:"عالٍ جداً", difficulty:4, careers:["مطور ويب","مهندس بيانات","خبير أمن","DevOps"],     desc:"أساس تخصصات التقنية — أكثر مرونة من الهندسة. تعلّم برمجة، AI، أمن معلومات.", riasec:"IC", universities:["AUB","LAU","AUT","LIU"],  roadmap:["رياضيات قوية","CS Entrance","4 سنوات CS","مشاريع عملية","شهادات احترافية"], certifications:["CompTIA Security+","AWS Solutions Architect","Google Data Analytics"], skills:["Python","JavaScript","Algorithms","Machine Learning","DevOps"] },
  { id:7,  name:"هندسة مدنية",       category:"الهندسة والتكنولوجيا", emoji:"🏗️", years:5,  lang:"إنجليزي/فرنسي", salaryMin:1200, salaryMax:2800,  salaryGulfMin:3500,  salaryGulfMax:6000,  demandLB:"متوسط",     demandGulf:"عالٍ جداً", difficulty:4, careers:["مهندس إنشاءات","مخطط مدن","مقاول","مشرف ميداني"],  desc:"البنية التحتية والمشاريع الكبرى. الخليج يبني ويحتاج مهندسين. نيوم وإكسبو دبي فتحا الطريق.", riasec:"RI", universities:["AUB","USJ","LAU","UOB"],  roadmap:["رياضيات وفيزياء","BAC","5 سنوات هندسة مدنية","PMP أو تخصص إنشائي","وظيفة خليج"], certifications:["PMP","PE License","LEED Green Associate"], skills:["AutoCAD","SAP2000","إدارة مشاريع","رسم هندسي","تحليل إنشائي"] },
  { id:8,  name:"هندسة كهربائية",    category:"الهندسة والتكنولوجيا", emoji:"⚡", years:5,  lang:"إنجليزي",       salaryMin:1200, salaryMax:3000,  salaryGulfMin:3500,  salaryGulfMax:6500,  demandLB:"عالٍ",      demandGulf:"عالٍ جداً", difficulty:4, careers:["مهندس طاقة","مهندس اتصالات","مهندس تحكم","Energy Consultant"], desc:"من الطاقة المتجددة للشبكات الذكية. الإمارات والسعودية تضخ مليارات في الطاقة الخضراء.", riasec:"RI", universities:["AUB","LAU","AUT","BAU"],  roadmap:["رياضيات وفيزياء","Entrance Exam","5 سنوات EE","تخصص طاقة/اتصالات","وظيفة"], certifications:["PE","PMP","Certified Energy Auditor"], skills:["MATLAB","SCADA","PLC","Circuit Analysis","Renewable Energy"] },
  { id:9,  name:"هندسة معمارية",     category:"الهندسة والتكنولوجيا", emoji:"🏛️", years:5,  lang:"إنجليزي/فرنسي", salaryMin:1000, salaryMax:2500,  salaryGulfMin:2800,  salaryGulfMax:5000,  demandLB:"متوسط",     demandGulf:"عالٍ",      difficulty:4, careers:["مهندس معماري","مصمم داخلي","مخطط عمراني","BIM Specialist"], desc:"الجمع بين الفن والعلم. لبنان مشهور عالمياً بمعمارييه — ALBA وAUB من أقوى البرامج.", riasec:"AR", universities:["AUB","USJ","ALBA","NDU"],  roadmap:["موهبة فنية وتقنية","Portfolio للقبول","5 سنوات عمارة","تدريب مكتب","Licensure"], certifications:["LEED AP","Autodesk Certified","BIM Professional"], skills:["AutoCAD","Revit","SketchUp","Rhino","Adobe CC","تصميم مستدام"] },
  // ── الأعمال والإدارة ────────────────────────────────────────────────────────
  { id:10, name:"إدارة أعمال",       category:"الأعمال والإدارة",      emoji:"💼", years:4,  lang:"إنجليزي/عربي",  salaryMin:800,  salaryMax:2500,  salaryGulfMin:2500,  salaryGulfMax:5500,  demandLB:"عالٍ",      demandGulf:"عالٍ جداً", difficulty:2, careers:["مدير تنفيذي","رائد أعمال","مستشار","مدير عمليات"],  desc:"أكثر التخصصات مرونةً. ESA وAUB تفتحان أبواب الشركات الكبرى.", riasec:"EC", universities:["AUB","LAU","ESA","LIU"],  roadmap:["BAC أي فرع","Entrance Exam","4 سنوات BBA","MBA بعد 5 سنوات عمل","Executive Track"], certifications:["PMP","MBA","CFA Level 1","Six Sigma"], skills:["Financial Analysis","PowerPoint","Excel","Leadership","Business Strategy"] },
  { id:11, name:"محاسبة وتمويل",     category:"الأعمال والإدارة",      emoji:"📊", years:4,  lang:"إنجليزي",       salaryMin:900,  salaryMax:2800,  salaryGulfMin:3000,  salaryGulfMax:5500,  demandLB:"عالٍ",      demandGulf:"عالٍ جداً", difficulty:3, careers:["محاسب قانوني CPA","محلل مالي","CFO","مراجع Big 4"], desc:"كل شركة تحتاج محاسباً — استقرار وظيفي عالٍ. Big 4 يوظفون كثيراً من خريجي لبنان.", riasec:"CE", universities:["AUB","LAU","LIU","BAU"],  roadmap:["رياضيات قوية","4 سنوات Accounting","CPA Exam","5 سنوات خبرة","ترقي لـCFO"], certifications:["CPA","CMA","CFA","ACCA"], skills:["Excel/Power BI","QuickBooks","IFRS","Financial Modeling","Audit"] },
  { id:12, name:"تسويق رقمي",        category:"الأعمال والإدارة",      emoji:"📱", years:4,  lang:"إنجليزي",       salaryMin:800,  salaryMax:2200,  salaryGulfMin:2500,  salaryGulfMax:4500,  demandLB:"عالٍ جداً", demandGulf:"عالٍ جداً", difficulty:2, careers:["مدير تسويق","خبير SEO/SEM","Growth Hacker","Brand Manager"], desc:"أسرع التخصصات نمواً في العصر الرقمي. كل شركة تحتاج Digital Marketer.", riasec:"EA", universities:["LAU","AUB","LIU","NDU"],  roadmap:["BAC أي فرع","4 سنوات Marketing","Google/Meta Certs","Portfolio مشاريع","Agency أو Brand"], certifications:["Google Ads","Meta Blueprint","HubSpot Marketing","SEMrush"], skills:["Google Analytics","Social Media","Content Strategy","SEO/SEM","Canva/Adobe"] },
  // ── الحقوق والعلوم السياسية ─────────────────────────────────────────────────
  { id:13, name:"حقوق",              category:"الحقوق والعلوم السياسية", emoji:"⚖️", years:4,  lang:"فرنسي/عربي",   salaryMin:1000, salaryMax:3000,  salaryGulfMin:3000,  salaryGulfMax:6000,  demandLB:"متوسط",     demandGulf:"متوسط",     difficulty:3, careers:["محامٍ","قاضٍ","مستشار قانوني","Corporate Lawyer"],  desc:"مهنة مرموقة تتطلب حدة التفكير. إمكانية الوصول لمراكز قيادية في الشركات والدولة.", riasec:"ES", universities:["USJ","LAU","AUB","UL"],   roadmap:["BAC","Entrance Exam","4 سنوات حقوق","امتحان نقابة المحامين","محاماة/قضاء"], certifications:["نقابة المحامين","LLM للتخصص"], skills:["كتابة قانونية","بحث قانوني","تفاوض","إقناع","تحليل نصوص"] },
  { id:14, name:"علوم سياسية",       category:"الحقوق والعلوم السياسية", emoji:"🌍", years:4,  lang:"إنجليزي/فرنسي", salaryMin:900,  salaryMax:2500,  salaryGulfMin:2500,  salaryGulfMax:4500,  demandLB:"متوسط",     demandGulf:"متوسط",     difficulty:2, careers:["دبلوماسي","محلل سياسي","UN Officer","صحفي دولي"],  desc:"فهم العالم وديناميكياته. ممتاز للعمل في المنظمات الدولية والسفارات.", riasec:"IS", universities:["AUB","LAU","USJ","NDU"],  roadmap:["BAC","4 سنوات Pol Science","Master in IR أو Diplomacy","Internship أممي","مسار دبلوماسي"], certifications:["UN Courses","IELTS/TOEFL"], skills:["تحليل سياسي","كتابة تقارير","دبلوماسية","لغات أجنبية","بحث"] },
  // ── الإعلام والفنون ─────────────────────────────────────────────────────────
  { id:15, name:"إعلام وصحافة",      category:"الإعلام والفنون",        emoji:"📰", years:4,  lang:"عربي/إنجليزي",  salaryMin:700,  salaryMax:2000,  salaryGulfMin:2000,  salaryGulfMax:4000,  demandLB:"متوسط",     demandGulf:"متوسط",     difficulty:2, careers:["صحفي","مذيع","مدير تحرير","Social Media Manager"], desc:"لبنان مركز إعلامي عربي رائد. الإعلام الرقمي والبودكاست فتحا فرصاً لا تعد.", riasec:"AE", universities:["LAU","AUB","USJ","NDU"],  roadmap:["BAC","4 سنوات صحافة","تدريب محطة/صحيفة","بناء Portfolio","Digital Media"], certifications:["Google Journalism","Reuters Journalism"], skills:["كتابة صحفية","تصوير","مونتاج","Adobe Premiere","SEO للمحتوى"] },
  { id:16, name:"تصميم غرافيكي",     category:"الإعلام والفنون",        emoji:"🎨", years:4,  lang:"إنجليزي",       salaryMin:700,  salaryMax:2000,  salaryGulfMin:2500,  salaryGulfMax:4500,  demandLB:"عالٍ",      demandGulf:"عالٍ",      difficulty:3, careers:["مصمم جرافيك","مصمم UX/UI","Motion Designer","Brand Identity"], desc:"إبداع بصري لا حدود له. الطلب متصاعد مع نمو الشركات الرقمية.", riasec:"AR", universities:["ALBA","LAU","NDU","USEK"],  roadmap:["Portfolio إبداعي","4 سنوات تصميم","Adobe CC احترافي","مشاريع حقيقية","Studio/Freelance"], certifications:["Adobe Certified","Google UX Design","Figma Professional"], skills:["Adobe Photoshop","Illustrator","Figma","Motion Graphics","Typography"] },
  // ── التربية ─────────────────────────────────────────────────────────────────
  { id:17, name:"تربية وتعليم",      category:"التربية",                emoji:"📚", years:4,  lang:"عربي/فرنسي",    salaryMin:600,  salaryMax:1600,  salaryGulfMin:2000,  salaryGulfMax:3500,  demandLB:"متوسط",     demandGulf:"عالٍ",      difficulty:2, careers:["معلم","مرشد تربوي","مدير مدرسة","Curriculum Developer"], desc:"من أنبل المهن. المدارس الدولية في الخليج تدفع رواتب مرتفعة للمعلمين المؤهلين.", riasec:"SA", universities:["LAU","LIU","NDU","UL"],   roadmap:["BAC","4 سنوات تربية","تدريب ميداني","شهادة تعليم دولية","IB/Cambridge"], certifications:["CELTA","IB Certificate","Cambridge CELTA"], skills:["إدارة صف","تخطيط دروس","تواصل","تكنولوجيا تعليمية","لغات"] },
  { id:18, name:"علم نفس",           category:"التربية",                emoji:"🧠", years:4,  lang:"إنجليزي/فرنسي", salaryMin:800,  salaryMax:2000,  salaryGulfMin:2200,  salaryGulfMax:4000,  demandLB:"عالٍ",      demandGulf:"عالٍ",      difficulty:3, careers:["معالج نفسي","مستشار HR","خبير تطوير","Psychologist"], desc:"الطلب يتزايد بشكل حاد. الاهتمام بالصحة النفسية ارتفع كثيراً.", riasec:"SI", universities:["USJ","LAU","AUB","NDU"],  roadmap:["BAC","4 سنوات علم نفس","Master إكلينيكي","تدريب سريري","ترخيص مزاولة"], certifications:["Board Certified Psychologist","CBT Certificate"], skills:["تقييم نفسي","علاج معرفي سلوكي","إحصاء","تواصل","بحث"] },
  // ── العلوم ──────────────────────────────────────────────────────────────────
  { id:19, name:"علوم بيئية",        category:"العلوم",                 emoji:"🌿", years:4,  lang:"إنجليزي",       salaryMin:900,  salaryMax:2200,  salaryGulfMin:2200,  salaryGulfMax:4000,  demandLB:"متوسط",     demandGulf:"عالٍ",      difficulty:3, careers:["خبير بيئي","مستشار طاقة متجددة","ESG Analyst","UN Expert"], desc:"مستقبل الكوكب. الإمارات والسعودية تضخ مليارات في الاستدامة والطاقة الخضراء.", riasec:"IR", universities:["AUB","LAU","UOB","NDU"],  roadmap:["علوم ورياضيات","4 سنوات بيئية","Master في Sustainability","شهادات بيئية","UN/NGO/Private Sector"], certifications:["LEED Green Associate","ISO 14001","ESG Analyst"], skills:["GIS/Remote Sensing","تقييم أثر بيئي","تحليل بيانات","Carbon Accounting"] },
  { id:20, name:"رياضيات وإحصاء",   category:"العلوم",                 emoji:"📐", years:4,  lang:"إنجليزي",       salaryMin:1000, salaryMax:3000,  salaryGulfMin:3000,  salaryGulfMax:5500,  demandLB:"متوسط",     demandGulf:"عالٍ جداً", difficulty:5, careers:["Data Scientist","Actuary","Quant Analyst","AI Researcher"], desc:"أساس الذكاء الاصطناعي وعلم البيانات. الشركات التقنية تدفع أعلى الرواتب لعلماء البيانات.", riasec:"IC", universities:["AUB","LAU","LIU","UL"],   roadmap:["رياضيات استثنائية","4 سنوات رياضيات","Master in Data Science/Stats","تدريب تقني","وظيفة FAANG"], certifications:["Google Data Analytics","Tableau Certified","Azure Data Scientist"], skills:["Python/R","Machine Learning","Statistics","Linear Algebra","Data Visualization"] },
  // ── الذكاء الاصطناعي والبيانات ──────────────────────────────────────────────
  { id:21, name:"ذكاء اصطناعي وتعلم الآلة", category:"الهندسة والتكنولوجيا", emoji:"🤖", years:4,  lang:"إنجليزي",       salaryMin:2000, salaryMax:5000,  salaryGulfMin:5000,  salaryGulfMax:9000,  demandLB:"عالٍ جداً", demandGulf:"عالٍ جداً", difficulty:5, careers:["AI Engineer","ML Engineer","Research Scientist","NLP Engineer"], desc:"أسرع تخصص نمواً في العالم. الشركات الكبرى كـ Google وMeta وMicrosoft تتنافس على خريجي الذكاء الاصطناعي.", riasec:"IR", universities:["AUB","LAU","AUT","LIU"],  roadmap:["رياضيات + برمجة قوية","4 سنوات CS/AI","Master in ML","مشاريع Kaggle/GitHub","وظيفة Big Tech"], certifications:["TensorFlow Developer","AWS ML Specialty","Deep Learning Specialization","PyTorch Certified"], skills:["Python","TensorFlow/PyTorch","Deep Learning","NLP","Computer Vision","Statistics"] },
  { id:22, name:"علم البيانات",          category:"الهندسة والتكنولوجيا", emoji:"📊", years:4,  lang:"إنجليزي",       salaryMin:1800, salaryMax:4000,  salaryGulfMin:4000,  salaryGulfMax:7500,  demandLB:"عالٍ جداً", demandGulf:"عالٍ جداً", difficulty:4, careers:["Data Scientist","Data Analyst","BI Developer","Product Analyst"], desc:"كل شركة تحتاج Data Scientist. لبنان يصدّر مواهب تقنية للعالم — الطلب يتضاعف سنوياً.", riasec:"IC", universities:["AUB","LAU","AUT","LIU"],  roadmap:["رياضيات + Python","4 سنوات CS أو Data Science","Bootcamp أو مشاريع","Portfolio قوي","وظيفة"], certifications:["Google Data Analytics","IBM Data Science","Power BI Certified","Tableau"], skills:["Python","SQL","Power BI/Tableau","Pandas","Machine Learning","Statistics"] },
  { id:23, name:"أمن المعلومات والشبكات", category:"الهندسة والتكنولوجيا", emoji:"🔐", years:4,  lang:"إنجليزي",       salaryMin:1800, salaryMax:4500,  salaryGulfMin:4500,  salaryGulfMax:8000,  demandLB:"عالٍ جداً", demandGulf:"عالٍ جداً", difficulty:4, careers:["Cybersecurity Analyst","Penetration Tester","Security Architect","CISO"], desc:"ثغرات أمنية تكلف مليارات. الشركات تدفع رواتب خيالية لحماية بياناتها — نقص حاد في الكوادر.", riasec:"IR", universities:["AUB","LAU","AUT","LIU"],  roadmap:["شبكات + برمجة","4 سنوات Cybersecurity أو CS","OSCP أو CEH","Bug Bounty Hunting","وظيفة"], certifications:["OSCP","CEH","CompTIA Security+","CISSP","Cisco CyberOps"], skills:["Networking","Linux","Python","Penetration Testing","Forensics","SIEM"] },
  // ── الهندسة الطبية والبيوطبية ───────────────────────────────────────────────
  { id:24, name:"هندسة طبية حيوية",       category:"الطب والصحة",           emoji:"🔬", years:5,  lang:"إنجليزي",       salaryMin:1500, salaryMax:3500,  salaryGulfMin:4000,  salaryGulfMax:7000,  demandLB:"عالٍ",      demandGulf:"عالٍ جداً", difficulty:5, careers:["Biomedical Engineer","Medical Device Designer","Clinical Engineer","R&D Specialist"], desc:"الجسر بين الطب والهندسة. تصميم الأجهزة الطبية والروبوتات الجراحية — مستقبل الرعاية الصحية.", riasec:"IR", universities:["AUB","LAU","AUT","BAU"],  roadmap:["رياضيات وعلوم قوية","5 سنوات هندسة طبية","تدريب مستشفى/شركة","شهادات متخصصة","وظيفة"], certifications:["Certified Biomedical Engineer","PMP","FDA Regulatory"], skills:["MATLAB","SolidWorks","Electronics","Programming","Medical Imaging","Regulatory Affairs"] },
  { id:25, name:"علاج فيزيائي",           category:"الطب والصحة",           emoji:"🦴", years:4,  lang:"إنجليزي/فرنسي", salaryMin:1000, salaryMax:2500,  salaryGulfMin:2500,  salaryGulfMax:4500,  demandLB:"عالٍ",      demandGulf:"عالٍ جداً", difficulty:3, careers:["معالج فيزيائي","أخصائي إعادة تأهيل","مدير وحدة PT","مدرب رياضي"], desc:"طلب متصاعد مع تزايد الوعي بإعادة التأهيل. المستشفيات والأندية الرياضية والخليج يحتاجون متخصصين.", riasec:"SI", universities:["LAU","USJ","BAU","LIU"],  roadmap:["BAC علوم","4 سنوات علاج فيزيائي","تدريب سريري","ترخيص وزارة الصحة","تخصص رياضي اختياري"], certifications:["NPTAE","PTA Board","IASTM Certified"], skills:["تقييم حركي","تمارين علاجية","Ultrasound/TENS","تشريح","توثيق سريري"] },
  // ── التغذية والغذاء ─────────────────────────────────────────────────────────
  { id:26, name:"تغذية وعلوم غذائية",     category:"الطب والصحة",           emoji:"🥗", years:4,  lang:"إنجليزي/فرنسي", salaryMin:800,  salaryMax:2000,  salaryGulfMin:2000,  salaryGulfMax:3800,  demandLB:"عالٍ",      demandGulf:"عالٍ",      difficulty:3, careers:["أخصائي تغذية","مستشار صحة","Food Technologist","صحفي تغذية"], desc:"الوعي الصحي يرفع الطلب سنوياً. المستشفيات والنوادي والمؤسسات الغذائية كلها تحتاج أخصائيين.", riasec:"SI", universities:["AUB","LAU","USJ","LIU"],  roadmap:["BAC علوم","4 سنوات تغذية","تدريب سريري 6 أشهر","ترخيص نقابة التغذية","عيادة أو مستشفى"], certifications:["RDN (Registered Dietitian)","CSSD للتغذية الرياضية"], skills:["تحليل غذائي","تخطيط وجبات","كيمياء غذاء","HACCP","تواصل مع مرضى"] },
  // ── الفندقة والسياحة ────────────────────────────────────────────────────────
  { id:27, name:"فندقة وإدارة سياحة",     category:"الأعمال والإدارة",      emoji:"🏨", years:4,  lang:"إنجليزي/فرنسي", salaryMin:800,  salaryMax:2200,  salaryGulfMin:2500,  salaryGulfMax:5000,  demandLB:"متوسط",     demandGulf:"عالٍ جداً", difficulty:2, careers:["مدير فندق","Event Planner","Travel Manager","F&B Director"], desc:"قطاع ضخم في الخليج وأوروبا. الإمارات تحتاج آلاف الكوادر الفندقية المؤهلة سنوياً.", riasec:"ES", universities:["LAU","LIU","NDU","USEK"],  roadmap:["BAC","4 سنوات فندقة","تدريب في فندق 5 نجوم","تخصص F&B أو Rooms","وظيفة فندق دولي"], certifications:["CPHQ","Certified Hotel Administrator","WSET Level 3"], skills:["Customer Service","Event Management","Revenue Management","اللغات","F&B Operations"] },
  // ── اللوجستيات والأعمال ─────────────────────────────────────────────────────
  { id:28, name:"لوجستيات وسلسلة التوريد", category:"الأعمال والإدارة",     emoji:"🚢", years:4,  lang:"إنجليزي",       salaryMin:1000, salaryMax:2800,  salaryGulfMin:3000,  salaryGulfMax:5500,  demandLB:"عالٍ",      demandGulf:"عالٍ جداً", difficulty:3, careers:["Supply Chain Manager","Logistics Analyst","Procurement Officer","Operations Manager"], desc:"التجارة العالمية تتوقف على اللوجستيات. دبي وقناة السويس وميناء بيروت محطات حيوية تحتاج كوادر.", riasec:"CE", universities:["AUB","LAU","LIU","AUT"],  roadmap:["BAC","4 سنوات لوجستيات أو أعمال","تدريب في شركة شحن","CSCMP أو APICS","وظيفة"], certifications:["CSCP (APICS)","CLTD","Six Sigma Green Belt","PMP"], skills:["SAP/Oracle","Warehouse Management","ERP Systems","Negotiation","Data Analysis"] },
  // ── الهندسة الميكانيكية ──────────────────────────────────────────────────────
  { id:29, name:"هندسة ميكانيكية",        category:"الهندسة والتكنولوجيا", emoji:"⚙️", years:5,  lang:"إنجليزي",       salaryMin:1200, salaryMax:3000,  salaryGulfMin:3500,  salaryGulfMax:6500,  demandLB:"متوسط",     demandGulf:"عالٍ جداً", difficulty:4, careers:["مهندس ميكانيكي","مهندس طاقة","مهندس إنتاج","مهندس HVAC"], desc:"أساس كل صناعة — من السيارات للطائرات. الخليج تصنيع ومصافٍ ومشاريع ضخمة لا تتوقف.", riasec:"RI", universities:["AUB","LAU","AUT","BAU"],  roadmap:["رياضيات وفيزياء","5 سنوات هندسة ميكانيكية","تدريب صناعي","AutoCAD/SolidWorks","وظيفة"], certifications:["PE License","SolidWorks Certified","PMP","Six Sigma"], skills:["SolidWorks/AutoCAD","Thermodynamics","HVAC","Fluid Mechanics","FEA/FEM"] },
  // ── الاتصالات ────────────────────────────────────────────────────────────────
  { id:30, name:"هندسة اتصالات وشبكات",   category:"الهندسة والتكنولوجيا", emoji:"📡", years:5,  lang:"إنجليزي",       salaryMin:1500, salaryMax:3500,  salaryGulfMin:4000,  salaryGulfMax:7000,  demandLB:"عالٍ",      demandGulf:"عالٍ جداً", difficulty:4, careers:["Network Engineer","Telecom Specialist","5G Engineer","IoT Developer"], desc:"5G والإنترنت من الأشياء يفجران الطلب. شركات الاتصالات الكبرى تتسابق على المهندسين المؤهلين.", riasec:"IR", universities:["AUB","LAU","AUT","LIU"],  roadmap:["فيزياء ورياضيات قوية","5 سنوات اتصالات","Cisco/Huawei Certs","5G Specialization","وظيفة دولية"], certifications:["CCNP","CCIE","Ericsson 5G","Huawei Certified"], skills:["MATLAB","RF Engineering","Network Protocols","Fiber Optics","5G/LTE","Python"] },
  // ── الإعلام والفنون ─────────────────────────────────────────────────────────
  { id:31, name:"سينما وإنتاج مرئي",      category:"الإعلام والفنون",        emoji:"🎬", years:4,  lang:"إنجليزي/عربي",  salaryMin:700,  salaryMax:2000,  salaryGulfMin:2500,  salaryGulfMax:5000,  demandLB:"متوسط",     demandGulf:"عالٍ",      difficulty:3, careers:["مخرج","محرر فيديو","منتج محتوى","Content Creator","VFX Artist"], desc:"ثورة المحتوى الرقمي وYouTube وNetflix فتحت أبواباً لا تُعد. الإنتاج البصري طلبه يتضاعف.", riasec:"AR", universities:["ALBA","LAU","NDU","AUST"],  roadmap:["Portfolio إبداعي","4 سنوات سينما أو إعلام","تدريب في شركة إنتاج","Adobe Premiere احترافي","مشاريع مستقلة"], certifications:["Adobe Certified Expert","DaVinci Resolve Certified"], skills:["Adobe Premiere","After Effects","DaVinci Resolve","Cinematography","Storytelling"] },
  // ── العلوم الاجتماعية ────────────────────────────────────────────────────────
  { id:32, name:"خدمة اجتماعية وتنمية",   category:"التربية",                emoji:"🤝", years:4,  lang:"عربي/إنجليزي",  salaryMin:700,  salaryMax:1800,  salaryGulfMin:2000,  salaryGulfMax:3500,  demandLB:"عالٍ",      demandGulf:"متوسط",     difficulty:2, careers:["أخصائي اجتماعي","مدير NGO","مستشار تنمية","موظف أممي"], desc:"لبنان مركز للمنظمات الدولية والإنسانية. UNHCR وUNICEF وعشرات المنظمات تحتاج متخصصين.", riasec:"SA", universities:["LAU","AUB","USJ","LIU"],  roadmap:["BAC","4 سنوات خدمة اجتماعية","تدريب NGO","ماستر تنمية مستدامة","UN/INGO"], certifications:["CSW Certificate","Project Cycle Management","MEAL Training"], skills:["إدارة مشاريع","تقرير وتوثيق","قيادة مجتمعية","بحث اجتماعي","لغات أجنبية"] },
];
