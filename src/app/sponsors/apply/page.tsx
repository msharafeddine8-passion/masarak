      ...
      <main dir="rtl" className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <div className="flex gap-3 justify-center mt-6">
            ...
            <Link href="/about" className="px-5 py-2.5 bg-gray-100 text-gray-700 rounded-xl font-bold text-sm">
              تعرّف على مسارك
            </Link>
          </div>
        </div>
    ...
    <main dir="rtl" className="min-h-screen bg-[#f8fafc] py-12 px-4">
      <div className="max-w-xl mx-auto">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="text-sm text-gray-400 hover:text-[#0F4A52] mb-4 inline-block">
            ← مسارك
          </Link>
        ...
        <div className="flex items-center gap-2 mb-6">
          {[1, 2, 3].map((s) => (
            <div key={s} className={`h-1.5 flex-1 rounded-full transition-all ${s <= step ? "bg-[#0F4A52]" : "bg-gray-200"}`} />
          ))}
        </div>
...
const inputCls = "w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#0F4A52]/30 focus:border-[#0F4A52]";
...
const btnGhostCls = "px-4 py-3 rounded-xl border-2 border-gray-200 text-gray-600 font-bold text-sm hover:border-gray-300 transition-colors";
