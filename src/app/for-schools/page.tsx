...
export const metadata = buildMetadata({
  ...
  description: "حلول مسارك للمدارس العربية: dashboard لمتابعة الطلاب، تقارير، ومحتوى توجيه. شراكات تعزّز إرشادك المهني.",
  path: "/for-schools",
    ...
    return (
      <main className="min-h-screen bg-bg py-12 px-4" dir="rtl">
        <div className="container mx-auto max-w-2xl">
          <Link href="/for-schools" className="text-sm text-ink-subtle hover:text-blue-700 mb-4 inline-block">
            ← العودة للمزايا
          </Link>
