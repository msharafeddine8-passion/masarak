    ...
    <div className="min-h-screen bg-light flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-primary">مرحباً بعودتك</h1>
          <p className="text-text-sub mt-1">سجّل دخولك لمتابعة مسارك</p>
        </div>

        <div className="card">
          <button onClick={handleGoogle}
            className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl py-3 font-semibold text-text-main hover:bg-gray-50 transition-colors mb-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-text-sub text-sm">أو</span>
            <div className="flex-1 h-px bg-gray-200"></div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} required
                className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-primary focus:outline-none transition-colors"
            ...
            <button type="submit" disabled={loading}
              className="w-full btn-primary py-3 rounded-xl disabled:opacity-60">
