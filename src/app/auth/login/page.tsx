              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button type="button" onClick={() => setShowPassword(v => !v)}
                    ...
                    className="absolute inset-y-0 left-2 my-auto h-8 w-8 flex items-center justify-center rounded-lg text-ink-subtle hover:text-primary hover:bg-bg-soft transition">
                    {showPassword ? (
