...
const BANNERS = [
  {
    ...
    subtitle: "عشرات المنح العربية والدولية — فلتر حسب تخصصك ومعدلك الآن",
    cta: "ابحث عن منحتك",
    href: "/scholarships",
    emoji: "🏆",
  ...
  },
  {
    id: 3,
    badge: "🏛️ دليل كامل",
    title: "دليل الجامعات العربية",
    subtitle: "تفاصيل مئات الجامعات العربية: رسوم، تخصصات، قبول، ومقارنة ذكية بينها",
    cta: "استكشف الجامعات",
    href: "/universities",
    emoji: "🏛️",
