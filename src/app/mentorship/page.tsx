...
export const metadata = buildMetadata({
  ...
  description: "احصل على mentor شخصي من خرّيجين عرب ناجحين. توجيه 1-on-1 مع خبراء بمجالك.",
  path: "/mentorship",
...
export default function MentorshipPage() {
  return (
    <ComingSoonPage
      ...
      description="قريباً: ربط الطلاب بخرّيجين عرب ناجحين بكل المجالات للحصول على إرشاد شخصي."
      features={[
        "Mentor matching حسب التخصص والاهتمامات",
        "جلسات 1-on-1 شهرية (30 دقيقة)",
        "نصائح مهنية، CV review، interview prep",
        "Mentors من Google, AUB, وشركات عربية رائدة",
